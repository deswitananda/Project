...
class Paket_haji extends CI_Controller {
    ...
    public function edit_paket_haji()
	{

		$id = $this->input->post('id');
		$q = $this->pm->getPaketHajiByID($id);
    ...
    public function save_paket_haji(){
		...
		if ($this->form_validation->run() == FALSE) {
            ...
            if ($id) {
                $update = $this->pm->updatePaketHaji($id, $data);
                if ($update) {
                    $ret = array(
                        'status' => true,
                ...
                $insert = $this->pm->insertPaketHaji($data);
    ...
    public function delete_paket_haji(){

		$id = $this->input->post('id');
		$data['deleted_at'] = time();
		$q = $this->pm->updatePaketHaji($id, $data);
    ...
    public function get_detail_paket_haji($id){
