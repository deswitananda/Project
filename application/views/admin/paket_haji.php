    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header align-center">
                <h4 class="title" id="largeModalLabel">Paket haji</h4>
            ...
            <div class="modal-body">
                <div class="card">
                    <div class="body">
                        <form id="form_paket_haji" method="post" novalidate>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary btnSave js-sweetalert"
                                    data-type="with-title" data-target="paket_haji">Simpan</button>
